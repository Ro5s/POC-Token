...
contract ERC20_223Factory {
    address[] public contracts;
    address public lastContractAddress;
    
    event newERC20_223Contract (
    ...
    function newERC20_223(string name, string symbol)
        public
        returns(address newContract)
    {
        ERC20_223 c = new ERC20_223(name, symbol);
        contracts.push(c);
        lastContractAddress = address(c);
        emit newERC20_223Contract(c);
        return c;
    }

    function seeERC20_223(uint pos)
        public
        constant
...
/**
 * @title ERC20_223
 * @dev ERC20_223 is an ERC223 Token with ERC20 functions and events
 *      Fully backward compatible with ERC20
 */
contract ERC20_223 is ERC223, Ownable {
